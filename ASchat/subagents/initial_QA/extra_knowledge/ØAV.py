...
Indledning (punkt 3.5.1)
Sagsfremstilling (punkt 3.5.2)
Motivering for forelæggelsen (punkt 3.5.3)
Tilslutning fra andre myndigheder (punkt 3.5.4)
Forslaget (punkt 3.5.5)
Finansministeriets tilslutning (punkt 3.5.6)
